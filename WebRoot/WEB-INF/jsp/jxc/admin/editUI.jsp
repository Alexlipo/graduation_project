	...
	function doVerify() {
		...
		if (account != "") {
			...
			$.ajax({
				...
				data : {
					"admin.account" : account,"admin.id": "${admin.id}"
				},
				type : "post",
				async : false,//非异步
...
<body class="rightBody">
	<form id="form" name="form"
		action="${basePath }jxc/admin_edit.action" method="post"
		...
		<div class="p_d_1">
			<div class="p_d_1_1">
				<div class="content_info">
					...
					<div class="tableH2" align="center">编辑管理员</div>
					<table id="baseInfo" width="30%" align="center" class="list"
						...
						<tr>
							...
							<td><s:textfield id="account" name="admin.account"
									onchange="doVerify()" /></td>
						</tr>
						<tr>
							<td class="tdBg" width="100px">密码:</td>
							<td><s:textfield id="pwd" name="admin.pwd" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><s:textfield id="tel" name="admin.tel" />
							</td>
						</tr>
					</table>
