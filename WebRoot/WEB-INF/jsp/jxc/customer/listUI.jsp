...
<script type="text/javascript">
		...
		function doSelectAll(){
      	...
      	//新增
      	function doAdd(){
      		document.forms[0].action = "${basePath}jxc/customer_addUI.action";
      		document.forms[0].submit();
      	}
      	//编辑
      	function doEdit(id){
      		document.forms[0].action = "${basePath}jxc/customer_editUI.action?customer.id=" + id;
      		document.forms[0].submit();
      	}
      	//删除
      	function doDelete(id){
      		document.forms[0].action = "${basePath}jxc/customer_delete.action?customer.id=" + id;
      		document.forms[0].submit();
      	}
      	//批量删除
      	function doDeleteAll(){
      		document.forms[0].action = "${basePath}jxc/customer_deleteSelected.action";
      		document.forms[0].submit();
      	}
      	//返回主页
      	function returnHome(){
...
<form name="form" action="" method="post" enctype="multipart/form-data">
	<table width="80%" border="1" cellspacing="0" cellpadding="0" align="center">
		<tr><td colspan="8" align="center">客户列表</td></tr>
		<tr>
			...
			<td width="140" align="center">地址</td>
			<td width="120" align="center">邮编</td>
			<td width="140" align="center">邮箱地址</td>
		...
		<s:iterator value="customerList" status="st">
			<tr <s:if test="#st.odd">bgcolor="f8f8f8"</s:if>>
				...
				<td align="center"><s:property value="postcode" />
				</td>
				<td align="center"><s:property value="email" />
				</td>
