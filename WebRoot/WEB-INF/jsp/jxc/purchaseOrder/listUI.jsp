...
<script type="text/javascript">
		...
		function doSelectAll(){
      	...
      	//新增
      	function doAdd(){
      		document.forms[0].action = "${basePath}jxc/purchaseOrder_addUI.action";
      		document.forms[0].submit();
      	}
      	//查看详细信息
      	function showDetail(id){
      		document.forms[0].action = "${basePath}jxc/purchaseOrder_showDetail.action?purchaseOrder.id=" + id;
      		document.forms[0].submit();
      	}
      	//删除
      	function doDelete(id){
      		document.forms[0].action = "${basePath}jxc/purchaseOrder_delete.action?purchaseOrder.id=" + id;
      		document.forms[0].submit();
      	}
      	//批量删除
      	function doDeleteAll(){
      		document.forms[0].action = "${basePath}jxc/purchaseOrder_deleteSelected.action";
      		document.forms[0].submit();
      	}
      	//返回主页
      	function returnHome(){
...
<form name="form" action="" method="post" enctype="multipart/form-data">
	<table width="60%" border="1" cellspacing="0" cellpadding="0" align="center">
		<tr><td colspan="6" align="center">采购订单列表</td></tr>
		<tr>
			...
			<td width="120" align="center">是否入库</td>
		</tr>
		<s:iterator value="purchaseOrderList" status="st">
