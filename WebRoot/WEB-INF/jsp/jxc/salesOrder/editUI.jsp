...
<body class="rightBody">
	<form id="form" name="form"
		action="${basePath }jxc/salesOrder_edit.action" method="post"
					...
					<table id="baseInfo" width="60%" align="center" class="list" border="1" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td><s:textfield id="order_date" name="salesOrder.order_date" readonly="true"
									...
									<s:param name="value"><s:date name="salesOrder.order_date" format="yyyy-MM-dd"/></s:param></s:textfield>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><s:textfield id="deliver_date" name="salesOrder.deliver_date" readonly="true"
									onfocus="WdatePicker({'skin':'whyGreen','dateFmt':'yyyy-MM-dd'});" >
									<s:param name="value"><s:date name="salesOrder.order_date" format="yyyy-MM-dd"/></s:param>
									</s:textfield>
							</td>
						</tr>
						<tr>
